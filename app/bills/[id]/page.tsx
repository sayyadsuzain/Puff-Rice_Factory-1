      ...
      <div className="container py-6 md:py-8">
        ...
        <div className="mb-4 md:mb-6 space-y-4 hidden-print">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 w-full">
            <Button
              variant="outline"
              className="gap-2 h-10 text-xs sm:text-sm"
              onClick={handlePrint}
              disabled={!partyName || partyName.trim() === ''}
            >
              <Printer className="h-4 w-4 text-gray-500" />
              <span>Print <span className="hidden sm:inline">PDF</span></span>
            </Button>

            <Button
              className="gap-2 bg-green-500 hover:bg-green-600 text-white h-10 text-xs sm:text-sm"
            ...
            <Button
              variant="default"
              className="gap-2 h-10 text-xs sm:text-sm bg-blue-600 hover:bg-blue-700"
              onClick={handleEdit}
            >
              <Edit2 className="h-4 w-4" />
              <span>Edit <span className="hidden sm:inline">Bill</span></span>
            </Button>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                ...
                >
                  ...
                  <span>Delete <span className="hidden sm:inline">Bill</span></span>
                </Button>
              </AlertDialogTrigger>
