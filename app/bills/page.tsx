...
export default function BillsPage() {
  ...
  const handlePrint = async (billId: number) => {
    try {
      ...
      // Import and render BillDisplay component
      const { default: BillDisplay } = await import('@/components/bill-display')
      ...
      await new Promise<void>((resolve) => {
        root.render(
          React.createElement(BillDisplay, {
            bill: bill,
            items: items || []
          })
        )
      ...
      const billElement = tempDiv.querySelector('.bill-display') as HTMLElement
      if (billElement) {
        const billHTML = billElement.outerHTML

        // Create print window (same as individual bill print)
        ...
        if (printWindow) {
          ...
          // Create the print page with exact styling (same as individual bill print)
