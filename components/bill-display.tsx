          ...
          <div className="text-right">
            ...
            {bill.balance && bill.balance > 0 && (
              <>
                ...
                <div className="text-lg font-bold">₹ {bill.balance.toFixed(2)}</div>
                <div className="font-bold mb-1 mt-2 border-t border-black pt-1">TOTAL</div>
                <div className="text-xl font-bold border-t-2 border-black pt-1">₹ {(bill.total_amount + bill.balance).toFixed(2)}</div>
              </>
            )}
            {(!bill.balance || bill.balance === 0) && (
